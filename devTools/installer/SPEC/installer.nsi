...
SectionGroup /e "OrangeHRM Appliance" SecGrpOrangeHRMAppliance
    ...
    Section "OrangeHRM 4.0.1" SecOrangeHRM
...
Section "-Register the application"
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "VersionMajor" "4.0.1"
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "VersionMinor" "2"
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "DisplayVersion" "4.0.1"
...
Section "-Complete"
      ...
      inetc::post "register" "http://127.0.0.1/orangehrm-4.0.1/installer/registrationMessage.php" "$INSTDIR\output.txt" 
...
; Descriptions
  ...
  LangString DESC_SecOrangeHRM ${LANG_ENGLISH} "OrangeHRM 4.0.1"
